...
public class Application1 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * for(int i = 0; i < 10; i++) {
		 * 		str4 = new StringBulider(str4).append(str1).toString();
		 * } 
		 * ---------------------------------------------------------------
		 * 직접 StringBuilder 작성 예시)
		 * ---------------------------------------------------------------
		 * String str1 = "java';
		 * String str2 = "oracle";
		 * 
